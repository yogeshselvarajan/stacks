...
export function CardSkeleton() {
  return (
    <div className="rounded-lg border p-4" style={{ borderColor: "var(--color-border)" }}>
      <div data-testid="skeleton-line" className="mb-2 h-4 w-2/3 animate-pulse rounded" style={{ background: "var(--color-border)" }} />
      <div data-testid="skeleton-line" className="mb-4 h-3 w-1/3 animate-pulse rounded" style={{ background: "var(--color-border)" }} />
